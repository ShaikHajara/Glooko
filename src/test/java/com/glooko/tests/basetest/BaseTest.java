...
public class BaseTest {
	...
	public void stopServer() {
		...
		cmd.addArgument("/c");
		cmd.addArgument("taskkill");
		cmd.addArgument("/F");
		cmd.addArgument("/IM");
		cmd.addArgument("node.exe");
	...
	public String appiumServerStart() throws InterruptedException{
		 ...
		 service=AppiumDriverLocalService.buildService(new AppiumServiceBuilder().withAppiumJS(new File("C:\\Users\\Shaik.Hajara\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js")).withIPAddress("127.0.0.1").usingPort(4723));
	     service.start();
	     Thread.sleep(5000);
